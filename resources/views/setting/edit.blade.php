    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                ...
                <br />
                 <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('setting.update', $data->id) }}" method="POST">
                ...
                <a href="{{ route('setting.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
