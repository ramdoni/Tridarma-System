    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                ...
                <br />
                 <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('premi.update', $data->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="form-control" name="tahun">
                                ...
                                <option {{ $data->tahun == $tahun ? 'selected':'' }}>{{ $tahun }}</option>
                                @endfor
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="rate" value="{{ $data->persen }}">
                        </div>
                    </div>                    
