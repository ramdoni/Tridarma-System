...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Form Pasiva</h3>
                <br />
                 <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('pasiva.store') }}" method="POST">
                    @if (count($errors) > 0)
                    ...
                    <div class="form-group">
                        <label class="col-md-12">Jenis Pasiva</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-md-12">Nama Pasiva</label>
                        <div class="col-md-6">
