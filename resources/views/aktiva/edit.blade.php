    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                ...
                <br />
                 <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('aktiva.update', $data->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="group">
                                @foreach(['A. Harta Lancar', 'B. Harta Tetap'] as $item )
                ...
                <a href="{{ route('aktiva.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
